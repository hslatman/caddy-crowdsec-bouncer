...
| `api_key`               | The API key to authenticate with CrowdSec/AppSec. Required when either enforcement path is enabled.                                                                  | `<empty>`                |
| `enable_crowdsec`       | Enables CrowdSec HTTP and Layer4 enforcement.                                                                                                                       | `true`                   |
| `enable_appsec`         | Enables AppSec request inspection.                                                                                                                                  | `true`                   |
